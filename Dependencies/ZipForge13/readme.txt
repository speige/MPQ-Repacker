...
ZipForge for Delphi / C++ Builder: README
=========================================
...
Program Purpose:
  ...
  With this toolkit you can easily add archive functionality 
  to your projects. 
Target Environment:
  Delphi 4, 5, 6, 7, 2005, 2006, 2007, 2009, 2010, XE-11 Alexandria and C++ Builder 4, 5, 6, 2006, 2007, 2009, 2010, XE-11 Alexandria.
...
ZipForge is a fast ZIP compression library. With this toolkit you can easily add archive functionality to your projects. 

ZipForge includes our new unique techonology, a transaction system. This innovative solution gives you a fast and easy way of updating archive files providing data integrity like a reliable database system. 
...
1) Make sure that all copies of Delphi (or C++ Builder) are currently 
   ...
   replacing an existing version of ZipForge, please remove all files and
   the package of the prior version before running the new setup program.

2) Unpack zip archive containing ZipForge into any directory. 
